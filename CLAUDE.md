...
- **Auto .venv**: All virtual environments are to be named `.venv` and located within backend-specific directories (e.g., `backend-py/.venv`), set up in such a way that they are auto activated upon entering the project root via WSL.

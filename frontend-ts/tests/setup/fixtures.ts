  ...
  projects: [
    {
      ...
      start_date: '2025-01',
      end_date: null,
      highlights: ['Built intelligent job matching system', 'Implemented auto-apply functionality'],
    },
  ],
  core_skills: ['React', 'TypeScript', 'Python', 'Node.js'],
  summary: 'Senior Software Engineer with 5+ years of experience building scalable web applications.',
};
